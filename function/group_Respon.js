...
var button = [{ buttonId: '!text_grup', buttonText: { displayText: 'Selamat Tinggal Kontol👋'}, type: 1 }]
await conn.sendMessage(
update.id, 
{
text: `*Selamat tinggal babi @${num.split("@")[0]}*\n*kalo mau balik lagi ke group ini, wajib bawa gorengan 1 truk😊*`,
buttons: button,
...
update.id, 
{ 
text: `*@${num.split("@")[0]} Selamat jadi admin babi*`,
buttons: button, 
footer: metadata.subject,
mentions: [num] })
}
...
update.id, 
{ 
text: `*@${num.split("@")[0]} Aowkwowk kena demote*`,
buttons: button, 
footer: metadata.subject,
mentions: [num] })
}
